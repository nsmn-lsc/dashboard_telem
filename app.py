...
fig, data_df = plot_pie_with_table(df_medica, columna)
...
st.dataframe(data_equip, use_container_width=True, hide_index=True)
...
st.dataframe(data_equip_med, use_container_width=True, hide_index=True)